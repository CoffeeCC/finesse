...
//   3. stage webos/staging/: appinfo.json + icons + bootstrap + baked.js bundle
...
const css = readFileSync(r('/dist-webos/app.css'), 'utf8')
const bundle = { version, css, js }
console.log(`  bundle: ${(js.length / 1024 / 1024).toFixed(2)} MB js + ${(css.length / 1024).toFixed(0)} kB css`)
...
// baked.js = the app baked into the .ipk (the safe fallback bundle)
writeFileSync(staging + '/baked.js', 'window.__BAKED__=' + JSON.stringify(bundle) + ';')
